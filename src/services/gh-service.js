...
exports.getGithubLinkFromNpm = exports.getDependencyData = exports.getResponsivenessData = exports.getLiscenseComplianceData = exports.getCorrectnessData = exports.getBusFactorData = void 0;
...
function getBusFactorData(repoUrl) {
    return __awaiter(this, void 0, void 0, function () {
        var _a, criticalUserLogin, criticalContrubitorCommits, totalCommits, _b, criticalContributorPullRequests, totalPullRequests;
        return __generator(this, function (_c) {
            switch (_c.label) {
                ...
                case 2:
                    _b = _c.sent(), criticalContributorPullRequests = _b[0], totalPullRequests = _b[1];
                    return [2 /*return*/, {
...
function getDependencyData(repoUrl) {
    return __awaiter(this, void 0, void 0, function () {
        var Dependencies;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    logger_1["default"].info('GH_SERVICE: running getDependencyData');
                    console.log('GH_SERVICE: running getDependencyData');
                    return [4 /*yield*/, ghApi.getDependencyList(repoUrl)];
                case 1:
