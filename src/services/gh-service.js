...
exports.getGithubLinkFromNpm = exports.getResponsivenessData = exports.getLiscenseComplianceData = exports.getCorrectnessData = exports.getBusFactorData = exports.getReviewData = exports.getDependencyScore = void 0;
var axios_1 = require("axios");
var ghApi = require("./gh-api");
var logger_1 = require("../logger");
function getDependencyScore(repoUrl) {
    return __awaiter(this, void 0, void 0, function () {
        var dependencies, pinnedCount, score;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    logger_1["default"].info('GH_SERVICE: running getDependencyScore');
                    return [4 /*yield*/, ghApi.getDependencies(repoUrl)];
                case 1:
                    dependencies = _a.sent();
                    if (dependencies.length === 0) {
                        return [2 /*return*/, 1.0]; // If no dependencies, score is 1.0
                    }
                    pinnedCount = 0;
                    ...
                    score = pinnedCount / dependencies.length;
                    return [2 /*return*/, score];
            }
        });
    });
}
exports.getDependencyScore = getDependencyScore;
/**
