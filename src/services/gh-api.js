...
exports.getAnualCommitCount = exports.getMonthlyCommitCount = exports.getLicense = exports.getIssues = exports.getPullRequestData = exports.getCommitData = exports.getDependencies = void 0;
var dotenv = require("dotenv");
var axios_1 = require("axios");
var logger_1 = require("../logger");
dotenv.config(); // load enviroment variables
function getDependencies(repoUrl) {
    return __awaiter(this, void 0, void 0, function () {
        var instance, repoOwner, repoName, response, packageJson, dependencies, devDependencies, combinedDependencies, error_1;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    logger_1["default"].info('GH_API: running getDependencies');
                ...
                case 3:
                    error_1 = _a.sent();
                    logger_1["default"].error('GH_API: getDependencies failed', error_1);
                    return [2 /*return*/, []];
...
function getPullRequestData(repoUrl, critUser) {
    return __awaiter(this, void 0, void 0, function () {
        var instance, repoOwner, repoName, response, crituserpullrequests, reviewedpullrequests, totalpullrequests, i, _a;
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                ...
                case 2:
                    ...
                    for (i = 0; i < totalpullrequests; i += 1) {
                        ...
                        if (response.data[i].requested_reviewers.length > 0) {
                            logger_1["default"].debug('GH_API: getRequestedReviewers {', response.data[i].requested_reviewers, '}');
                            reviewedpullrequests += 1;
                        }
                    }
                    logger_1["default"].debug('GH_API: getPullRequestData {', crituserpullrequests, reviewedpullrequests, totalpullrequests, '}');
                    return [2 /*return*/, [crituserpullrequests, reviewedpullrequests, totalpullrequests]];
                case 3:
                    _a = _b.sent();
